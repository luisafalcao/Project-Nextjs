...
export const listarLancamentos = async () => {
    ...
    let lancamentos;
    const apiUrl = `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&language=en-US&primary_release_date.gte=${last30days}&sort_by=popularity.desc&append_to_response=runtime`
